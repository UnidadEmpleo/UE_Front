...
export default {
  ...
  props: {
    ...
    clase: { type: String, default: "default", },
...
.input-group .form-control:hover {
  ...
  box-shadow: 0 0 0 2px rgba(195, 235, 17, 0.15);
...
.input-group.is-focused input[type="datetime-local"]~.form-label {
  font-size: 14px !important;
  font-weight: 600 !important;
  color: #633455 !important;

}

/* Asegurar que la etiqueta siempre esté por encima del input (y de su sombra de autofill) */
.input-group .form-label {
  z-index: 3 !important;
  pointer-events: none; /* Permite que los clics pasen a través de la etiqueta al input */
}
...
.input-group.is-focused .form-label {
  font-size: 14px !important;
  font-weight: 600 !important;
  color: #858183 !important;
}


/* Eliminar el fondo gris/amarillo del autocompletado */
...
input:-webkit-autofill:active {
  ...
  -webkit-text-fill-color: #495057 !important; /* Color del texto de tu tema */
  transition: background-color 5000s ease-in-out 0s;
}

/* Si usas modo oscuro o fondos transparentes, esto ayuda a que no se note el cambio */
