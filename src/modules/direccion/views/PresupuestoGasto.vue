<template>
  <div class="container-fluid py-4">
    <div class="card mt-4">
      ...
      <div class="card-body pt-0">
        <div class="mb-3 d-flex gap-2 align-items-center">
          ...
          <MaterialComboBox v-model="filters.farmaciaId" :options="farmacias" :numericValue="false" />
          <label class="small mb-0">Ejercicio</label>
          <MaterialInput type="number" v-model.number="filters.ejercicio" />
    ...
    <div class="modal" :class="{ show: showModal }" style="display: block;" v-if="showModal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-2">
              ...
              <MaterialComboBox v-model="form.farmaciaId" :options="farmacias" :numericValue="false" />
            </div>
            <div class="row">
              <div class="col-md-6 mb-2">
                <label class="form-label small">Año</label>
                <MaterialComboBox v-model="form.year" :options="yearsOptions" :numericValue="true" />
              </div>
              <div class="col-md-6 mb-2">
                <label class="form-label small">Mes</label>
                <MaterialComboBox v-model="form.month" :options="monthsOptions" :numericValue="true" />
              </div>
            </div>
            <div class="mb-2">
              <label class="form-label small">Presupuesto</label>
              <MaterialInput type="number" v-model.number="form.presupuesto" />
            </div>
            <div class="mb-2">
...
export default {
  ...
  setup() {
    ...
    const columns = ['Farmacia', 'Ejercicio', 'Presupuesto', 'Gasto', 'Porcentaje']
    ...
    onMounted(async () => {
      ...
      if (!farmacias.value || !farmacias.value.length) {
        ...
        try { await direccionStore.loadAll() } catch (e) { }
      }
      if (farmacias.value && farmacias.value.length) {
